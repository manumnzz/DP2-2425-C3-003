...
<acme:form>
    <jstl:choose>
        ...
        <jstl:when test="${acme:anyOf(_command, 'show|update|delete|publish')}">
            ...
            <acme:input-select code="customer.booking.form.label.travelClass" path="travelClass" choices="${travelClass}" readonly="true" />
            <acme:input-money code="customer.booking.form.label.price" path="price" readonly="true"/>
            <acme:input-textbox code="customer.booking.form.label.lastCreditCardNibble" path="lastCreditCardNibble" readonly="true"/>
            <acme:input-checkbox code="customer.booking.form.label.draftMode" path="draftMode" readonly="true"/>
