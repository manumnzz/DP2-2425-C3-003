...
<acme:form>
	<acme:input-moment code="assistanceagent.claim.form.label.moment" path="moment"/>
	...
	<acme:input-select code="assistanceagent.claim.form.label.type" path="type" choices="${choices}"/>
	<acme:input-checkbox code="assistanceagent.claim.form.label.indicator" path="indicator"/>
	<jstl:choose>
