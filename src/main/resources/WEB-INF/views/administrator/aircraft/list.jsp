...
<acme:list>
	...
	<acme:list-column code="administrator.aircraft.list.label.airline" path="airline" width="25%"/>
	
</acme:list>

<acme:button code="administrator.aircraft.form.button.create" action="/administrator/aircraft/create"/>